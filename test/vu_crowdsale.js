    ...
    context("Presale", async () => {
        ...
        it('shouldn\'t allow to deploy Presale contract with invalid Whitelist param', async () => {
          try {
              ...
              await PresaleCrowdsale.new(VUToken.address, 0x0, WALLETS.MARGE, WALLETS.LISA, deliveryTime);
        ...
        it('shouldn\'t allow to deploy Presale contract with invalid deliveryTime param', async () => {
          try {
              await PresaleCrowdsale.new(VUToken.address, Whitelist.address, WALLETS.MARGE, WALLETS.LISA, 0);
          ...
          try {
              ...
              await PresaleCrowdsale.new(VUToken.address, Whitelist.address, WALLETS.MARGE, WALLETS.LISA, deliveryTime);
